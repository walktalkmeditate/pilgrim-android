...
class TranscriptionWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        ...
        return outcome.fold(
            ...
            onFailure = { error ->
                // A model that is still downloading (the runner just
                // re-enqueued delivery) or any other model-load failure
                // is plausibly transient. Ask WorkManager to back off
                // and retry rather than marking the walk's transcription
                // permanently failed.
