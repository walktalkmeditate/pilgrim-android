    ...
    PilgrimDetailScaffold(
        ...
        Box(
            modifier = Modifier
                .fillMaxSize()
                .padding(padding)
                // Edge-to-edge app: inset the WebView above the gesture nav
                // so the viewer's bottom content isn't drawn behind it
                // (Android WebView doesn't expose this inset to CSS env()).
