...
- **`close` remediation status (updated 2026-05-16):**
  ...
  - **Still open `close` (remediation pending):** goshuin.populated (iOS filter bar All/Transformative/Peaceful/Extraordinary + "Share Goshuin" + modal-sheet presentation — large feature). [settings.sound storageSection RESOLVED 2026-05-16 — download-progress row shipped.]
